...
{	
	if(arg.key == OIS::KC_ESCAPE)
        ...
        {
			myself->updateControlAxis(RBUMP, 1);
        }
    else if (arg.key == OIS::KC_P)
    	{
    		myself->updateControlAxis(LBUMP, 1);
    	}
...
bool Cobalt::keyReleased( const OIS::KeyEvent &arg )
{
     if (arg.key == OIS::KC_W)
        ...
        {
			myself->updateControlAxis(RBUMP, 0);
        }
    else if (arg.key == OIS::KC_P)
        {
			myself->updateControlAxis(LBUMP, 0);
        }
...
/*the different buttons are LBUMP,RBUMP, LJOYCLICK, RJOYCLICK
 ...
 bool Cobalt::buttonPressed( const OIS::JoyStickEvent &e, int button )
 {
 	...
 	{
		case LBUMP:
		myself->updatePlayerState(SHOOTING1, true);
		break;
		case RBUMP:
		myself->updatePlayerState(SHOOTING2, true);
		break;
		case LJOYCLICK:
		myself->updatePlayerState(JUMPING, true);
		break;
		case RJOYCLICK:
		myself->updatePlayerState(JUMPING, true);
		break;
 ...
 bool Cobalt::buttonReleased( const OIS::JoyStickEvent &e, int button )
 {
 	...
 	{
		case LBUMP:
		myself->updatePlayerState(SHOOTING1, false);
		break;
		case RBUMP:
		myself->updatePlayerState(SHOOTING2, false);
		break;
		case LJOYCLICK:
		myself->updatePlayerState(JUMPING, false);
		break;
		case RJOYCLICK:
		myself->updatePlayerState(JUMPING, false);
		break;
